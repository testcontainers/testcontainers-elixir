defmodule Testcontainers.ContainerTest do
  ...
  describe "hash" do
    test "returns the same hash for the same container" do
      ...
      assert Testcontainers.Util.Hash.struct_to_hash(container1) == "17e0c368f25267acd5af3d9dc81ee59948373428c6699eb16b6cd06ad2d48261"
      assert Testcontainers.Util.Hash.struct_to_hash(container2) == "17e0c368f25267acd5af3d9dc81ee59948373428c6699eb16b6cd06ad2d48261"
    end
  end
