defmodule Testcontainers.ContainerTest do
  ...
  describe "hash" do
    test "returns the same hash for the same container" do
      ...
      assert Testcontainers.Util.Hash.struct_to_hash(container1) == "48eb6f7a969bf14d270caf14b2d0ed7d78a940119edb2366c4a1b67ae67924f1"
      assert Testcontainers.Util.Hash.struct_to_hash(container2) == "48eb6f7a969bf14d270caf14b2d0ed7d78a940119edb2366c4a1b67ae67924f1"
    end
  end
