defmodule Testcontainers.ConstantsTest do
  ...
  test "have correct values" do
    ...
    assert Testcontainers.Constants.container_reuse_hash_label() == "org.testcontainers.reuse-hash"
    assert Testcontainers.Constants.container_reuse() == "org.testcontainers.reuse"
