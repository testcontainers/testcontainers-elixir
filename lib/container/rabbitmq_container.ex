defmodule Testcontainers.RabbitMQContainer do
  ...
  NOTE: Currently untested, any developer who tries to add improvements on this container, should consider moving this to container impl to a separate elixir package.
  """
